...
export class AppComponent {
  ...
  //<-----------------------------to-do using two-way data binding----------------->
  // item:string;
  // todoItems:string[]=[];
  // //to add item
  // addItem(){
  ...
  //<---------------------Form  --->Submitting a form in angular-------------->
  ...
  //<---Form  --->Submitting a form in angular as accordian n delete accordian-------------->
  // title='Assignment-19';
  // users=[];
  // addUserData(ref:NgForm){
  //   let userObj=ref.value;
  ...
  //<---------------------Form two way data binding --->Submitting a form in angular-------------->
